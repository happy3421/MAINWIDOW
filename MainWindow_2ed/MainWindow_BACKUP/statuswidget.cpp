		...
		if(record->gethowMany() <= 10){
			for(i=0;i<record->gethowMany();i++){
				...
				if(record->gettimeRecord()[i][5] == 0){
					ARESULT[i]->setPixmap(QPixmap(QString::fromUtf8("Resources/test3.jpg")));
					BRESULT[i]->setPixmap(QPixmap(QString::fromUtf8("Resources/test2.jpg")));
				}
				else{
					ARESULT[i]->setPixmap(QPixmap(QString::fromUtf8("Resources/test2.jpg")));
					BRESULT[i]->setPixmap(QPixmap(QString::fromUtf8("Resources/test3.jpg")));
				}
			}
			for(int j=i; j<10;j++){
	...
	case 1:
		if(record->gethowMany() <= 20){
			for(i=10;i<record->gethowMany();i++){
				...
				PAST += "\n\n";
				if(record->gettimeRecord()[i][5] == 0){
					ARESULT[i-10]->setPixmap(QPixmap(QString::fromUtf8("Resources/test3.jpg")));
					BRESULT[i-10]->setPixmap(QPixmap(QString::fromUtf8("Resources/test2.jpg")));
				}
				else{
					ARESULT[i-10]->setPixmap(QPixmap(QString::fromUtf8("Resources/test2.jpg")));
					BRESULT[i-10]->setPixmap(QPixmap(QString::fromUtf8("Resources/test3.jpg")));
				}
			}
			for(int j=i; j<20;j++){
