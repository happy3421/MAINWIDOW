...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StatusWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 37, 6)
    ...
    "StatusWidget\0goToSelect\0\0replay\0next\0"
    "before"
};
...
const QMetaObject StatusWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StatusWidget.data,
      qt_meta_data_StatusWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StatusWidget.stringdata))
